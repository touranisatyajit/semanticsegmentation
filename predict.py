...
parser.add_argument('--image', type=str, default="/home/tourani/Desktop/deep/Semantic-Segmentation-Suite-master/CamVid/test/frame000000.jpg", required=False, help='The image you want to predict on. ')
parser.add_argument('--checkpoint_path', type=str, default="/home/tourani/Desktop/deep/Semantic-Segmentation-Suite-master/checkpoints/latest_model_FC-DenseNet56_CamVid.ckpt", required=False, help='The path to the latest checkpoint weights for your model.')
parser.add_argument('--crop_height', type=int, default=320, help='Height of cropped input image to network')
parser.add_argument('--crop_width', type=int, default=672, help='Width of cropped input image to network')
